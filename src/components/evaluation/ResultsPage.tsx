          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="px-0 py-6 pt-0 pb-2">
                ...
                <p className="md:hidden text-center text-xs text-gray-500 mt-1">Toque no gráfico para ampliar</p>
              </CardContent>
            </Card>

            <Dialog open={isChartOpen} onOpenChange={setIsChartOpen}>
              <DialogContent className={`${isMobile ? 'max-w-[90vw] w-[90vw]' : 'max-w-[900px]'}`}>
                <DialogHeader>
